...
int main() {
    ...
    try {
       ...
       mlp.setOptimizer(OptimizerType::Adam, 0.001f);  // Tasa de aprendizaje típica para Adam
        ...
        mlp.trainDataset(train_images, train_labels, full_epochs,1, prefix + "_train_" + to_string(full_epochs) +"epochs_adam.csv");
       ...
       mlp2.setOptimizer(OptimizerType::RMSProp, 0.001f);  // Tasa de aprendizaje típica para Adam
        ...
        mlp2.trainDataset(train_images, train_labels, full_epochs,1, prefix + "_train_" + to_string(full_epochs) +"epochs_RMS.csv");
       ...
       mlp3.setOptimizer(OptimizerType::SGD, 0.001f);  // Tasa de aprendizaje típica para Adam
        ...
        mlp3.trainDataset(train_images, train_labels, full_epochs,1, prefix + "_train_" + to_string(full_epochs) +"epochs_sgd.csv");
